...
export const projects: Project[] = [
  // AI Projects
  {
    ...
    featured: true,
    tracks: [
      { title: "Problem Statement", content: "Traditional portfolios lack interactivity and don't allow visitors to ask specific questions about a developer's experience.", duration: "2 min", type: "problem" },
      { title: "Solution Architecture", content: "Built an AI chatbot using Groq Cloud (OpenAI-compatible) for dynamic natural-language responses about skills, experience, and projects.", duration: "4 min", type: "solution" },
      { title: "Performance Optimization", content: "Achieved 35% faster load time and 20% higher Lighthouse score through code-splitting, image lazy-loading, and preloading techniques.", duration: "3 min", type: "feature" },
      { title: "GitHub Integration", content: "Intelligent project summarization by fetching and parsing GitHub README content with reusable utilities and modular components.", duration: "3 min", type: "feature" },
    ],
  },
  // Web Applications
  {
    ...
    thumbnail: projectAiChatbot,
    images: [projectAiChatbot],
    category: "web",
    technologies: ["React.js", "Node.js", "Express.js", "MongoDB", "TypeScript", "Gemini AI", "Groq AI"],
    role: "Full-stack Developer",
    duration: "4 months",
    ...
    featured: true,
    tracks: [
      { title: "Problem Statement", content: "Users need a way to extract and summarize knowledge from Instagram Reels efficiently with multilingual support.", duration: "2 min", type: "problem" },
      { title: "Solution Architecture", content: "Built a 7-stage automated processing pipeline integrating Gemini AI for audio transcription and Groq AI for multilingual summarization OCR.", duration: "5 min", type: "solution" },
      { title: "Performance Optimization", content: "Boosted reel processing performance by 40-50% through parallel execution, optimized FFmpeg audio extraction, singleton Puppeteer browser pool, and MongoDB compound + full-text indexes.", duration: "4 min", type: "feature" },
      { title: "Production Features", content: "JWT-based authentication, bcrypt hashing, centralized error handling, React Context + TanStack Query state management, and MongoDB aggregation pipelines.", duration: "3 min", type: "feature" },
    ],
  },
  {
    id: "url-shortener",
    ...
    featured: true,
    tracks: [
      { title: "Problem Statement", content: "Users need a simple way to shorten URLs and track their usage with click analytics.", duration: "2 min", type: "problem" },
      { title: "Backend Architecture", content: "Created RESTful APIs with modular controller-service architecture for improved maintainability and scalability.", duration: "4 min", type: "solution" },
      { title: "Key Features", content: "Real-time redirection, click tracking, and responsive React.js frontend with clean UI.", duration: "3 min", type: "feature" },
      { title: "Best Practices", content: "Collaborated during code reviews to maintain clean, well-documented code with responsive design.", duration: "2 min", type: "feature" },
    ],
  },
  {
    id: "img-enhancer",
    ...
    images: [projectSpotifyStats, projectAiChatbot, projectLinktree],
    category: "frontend",
    technologies: ["React.js", "Firebase Auth", "Vite", "Tailwind CSS", "Axios", "Framer Motion"],
    ...
    featured: true,
    tracks: [
      { title: "Problem Statement", content: "Users need an easy way to enhance images and remove backgrounds without complex software.", duration: "2 min", type: "problem" },
      { title: "Key Features", content: "Firebase Authentication (Email/Password & Google), Dark/Light Theme Toggle, Image Background Removal using Aoscdn Visual Segmentation API.", duration: "4 min", type: "feature" },
      { title: "UX Features", content: "Drag & Drop File Upload with Preview, Responsive Dashboard with Protected Routes.", duration: "3 min", type: "feature" },
      { title: "Performance", content: "Optimized with Brotli/Gzip compression, minified JavaScript, tree-shaking, lazy loading, and LCP below 2.5s.", duration: "3 min", type: "solution" },
    ],
  },
  {
    id: "scsdb-movies-app",
    ...
    thumbnail: projectSpotifyStats,
    category: "frontend",
    technologies: ["React.js", "Redux Toolkit", "Tailwind CSS", "React Router", "Axios", "TMDB API"],
    role: "Frontend Developer",
    duration: "2 months",
    ...
    featured: true,
    tracks: [
      { title: "Problem Statement", content: "Movie enthusiasts need a clean, fast way to discover and explore movies, TV shows, and actors.", duration: "2 min", type: "problem" },
      { title: "Solution Architecture", content: "Built with ReactJS for efficient UI, Redux Toolkit for state management, and Axios for fetching data from TMDB API.", duration: "4 min", type: "solution" },
      { title: "Key Features", content: "Trending titles, detailed information pages, insightful reviews, and seamless navigation with React Router Dom.", duration: "3 min", type: "feature" },
      { title: "Styling & Deployment", content: "Rapid styling with Tailwind CSS, Remix Icons for visual appeal, and Netlify for robust hosting.", duration: "2 min", type: "feature" },
    ],
  },
  {
    ...
    featured: false,
    tracks: [
      { title: "Design Concept", content: "Spotify-inspired UI with familiar navigation patterns, player bar, and library sidebar for showcasing projects.", duration: "3 min", type: "solution" },
      { title: "Key Features", content: "Animated transitions, responsive design, project filtering, and detailed project views with track-like information.", duration: "4 min", type: "feature" },
      { title: "Tech Stack", content: "Modern stack with React, TypeScript for type safety, Tailwind CSS for styling, and Framer Motion for animations.", duration: "3 min", type: "feature" },
    ],
  },
];
...
export const experiences: Experience[] = [
  {
    ...
    technologies: ["Angular", "React", "TypeScript", "Redux Toolkit", "RxJS", ".NET Core", "REST APIs"]
  }
];
...
export const aboutMe = {
  ...
  pullQuote: "Building scalable solutions with clean code and great user experience.",
  timeline: [
    { year: "2021", event: "Started B.E. in Computer Engineering at Sinhgad Institute" },
    { year: "2024", event: "Built AI-powered projects: ReelMind & Portfolio Assistant" },
    { year: "2025", event: "Graduated with B.E., Joined Enprosys Infotech" },
    { year: "2025", event: "Working on enterprise ERP applications with Angular & React" }
  ],
  interests: [
    { icon: "🤖", name: "AI/ML", description: "Building AI-powered applications" },
    { icon: "💻", name: "Full-Stack Dev", description: "MERN, Angular, .NET Core" },
    { icon: "🌱", name: "Open Source", description: "Contributing to web ecosystem" },
