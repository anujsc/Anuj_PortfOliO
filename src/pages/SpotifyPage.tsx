    ...
    >
      ...
      <div className="mt-6 bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-6 border border-primary/20">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed">
          The right music can transform your coding experience. This playlist is
          carefully curated to help you enter flow state, maintain focus, and
          boost productivity. Whether you're tackling complex algorithms or
          building beautiful UIs, these tracks will keep you in the zone.
        </p>
      </div>
    </motion.div>
  );
